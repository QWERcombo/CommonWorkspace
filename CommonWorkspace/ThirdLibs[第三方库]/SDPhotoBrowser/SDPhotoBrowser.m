...
- (void)setupScrollView
{
    ...
    for (int i = 0; i < self.imageCount; i++) {
        SDBrowserImageView *imageView = [[SDBrowserImageView alloc] initWithFrame:[UIScreen mainScreen].bounds];
        imageView.tag = i;
...
- (void)photoClick:(UITapGestureRecognizer *)recognizer
{
    ...
    if (self.sourceImagesContainerView.subviews.count > currentIndex) {
        sourceView = _backToSourceView?self.sourceImagesContainerView:self.sourceImagesContainerView.subviews[currentIndex];
    } else {
...
- (void)showFirstImage
{
    ...
    if (self.sourceImagesContainerView.subviews.count > self.currentImageIndex) {
        sourceView = _backToSourceView?self.sourceImagesContainerView:self.sourceImagesContainerView.subviews[self.currentImageIndex];
    } else {
        sourceView = [[UIView alloc] initWithFrame:CGRectZero];
    }
